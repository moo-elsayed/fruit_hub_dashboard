...
void main() {
  ...
  group('createUserWithEmailAndPassword', () {
    ...
    test('should return NetworkFailure with emailAlreadyInUse and NOT delete currentUser when FirebaseAuthException is email-already-in-use', () async {
      // Arrange
      when(
        () => mockFirebaseAuth.createUserWithEmailAndPassword(
          email: tEmail,
    ...
    test('should return NetworkFailure with thePasswordProvidedIsTooWeak and delete currentUser when FirebaseAuthException is weak-password', () async {
      // Arrange
      when(
        () => mockFirebaseAuth.createUserWithEmailAndPassword(
          email: tEmail,
    ...
    test('should return NetworkFailure with invalidEmail and delete currentUser when FirebaseAuthException is invalid-email', () async {
      // Arrange
      when(
        () => mockFirebaseAuth.createUserWithEmailAndPassword(
          email: tEmail,
    ...
    test('should return NetworkFailure with unexpectedError and delete currentUser when generic exception occurs', () async {
      // Arrange
      when(
        () => mockFirebaseAuth.createUserWithEmailAndPassword(
          email: tEmail,
    ...
    test('should delete currentUser and return NetworkFailure when user.updateDisplayName throws an exception', () async {
      // Arrange
      when(
        () => mockFirebaseAuth.createUserWithEmailAndPassword(
          email: tEmail,
  ...
  group('signInWithEmailAndPassword', () {
    test('should successfully sign in, reload user, update verified status in Firestore and return NetworkSuccess when user exists in DB', () async {
      // Arrange
      await fakeFirestore
          .collection(BackendEndpoints.usersCollection)
          .doc(tUid)
    ...
    test('should successfully sign in and create new Firestore doc if user did not exist in DB', () async {
      // Arrange
      when(
        () => mockFirebaseAuth.signInWithEmailAndPassword(
          email: tEmail,
    ...
    test('should return NetworkFailure with wrongPasswordProvidedForThatUser on wrong-password code', () async {
      // Arrange
      when(
        () => mockFirebaseAuth.signInWithEmailAndPassword(
          email: tEmail,
    ...
    test('should return NetworkFailure with invalidCredential on invalid-credential code', () async {
      // Arrange
      when(
        () => mockFirebaseAuth.signInWithEmailAndPassword(
          email: tEmail,
    ...
    test('should return NetworkFailure with noInternetConnection on network-request-failed code', () async {
      // Arrange
      when(
        () => mockFirebaseAuth.signInWithEmailAndPassword(
          email: tEmail,
  ...
  group('googleSignIn', () {
    test('should successfully sign in with Google provider and return NetworkSuccess with UserModel', () async {
      // Arrange
      final mockAdditionalInfo = MockAdditionalUserInfo();
      when(() => mockAdditionalInfo.profile)
    ...
    test('should preserve stored name when user already exists in DB with a non-empty name', () async {
      // Arrange
      await fakeFirestore
          .collection(BackendEndpoints.usersCollection)
          .doc(tUid)
